 <div align="center"> 
  ...
  <p> <h1 align="center" style="color: green">  Tinker  <sub style="color:black">e-commerce </sub></h1> </p>
    ...
    <tr  style="background-color:#04AA6D;">
        ...
        <th style="border: 5px solid #04AA6D; width: 10px;"><a style="text-decoration:none; color:#fff;" href="signup.php">Register</a></th>
        <th style="border: 5px solid #04AA6D;width: 10px;"><a style="text-decoration:none; color:#fff;" href="home.php">Home</a></th>
    </tr>
    </table>
