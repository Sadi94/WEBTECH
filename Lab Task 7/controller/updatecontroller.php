...
if (isset($_POST['updateTinker']) && isset($_SESSION['username'])) {
...
if($flag==1)
{
  ...
  if (updateTinker($_SESSION['username'],$data)) 
  {
    echo 'Successfully updated!!';
    echo "<br><a href='../view/dashboard.php'>Back to Dashboard</a>";
  }
 ...
 else 
{
  ...
  echo "<br><a href='../view/dashboard.php'>Go to Dashboard</a>";
